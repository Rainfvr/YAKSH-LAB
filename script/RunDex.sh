...
for filename in $varname/raw/*.lif; do
	...
	/home/analysis/Desktop/MH_pipeline/bftools/bfconvert -channel 2 $filename $varname/neu/"$newfile"_neu.tif
	/home/analysis/Desktop/MH_pipeline/bftools/bfconvert -channel 1 $filename $varname/mac/"$newfile"_mac.tif
	/home/analysis/Desktop/MH_pipeline/bftools/bfconvert -channel 0 $filename $varname/bv/"$newfile"_bv.tif
