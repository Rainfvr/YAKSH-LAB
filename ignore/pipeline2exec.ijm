//Matt's Magic Macrophage Macro...Masks Macrophages, Makes Maps, + Much More

// asks user to input the folder containing the all files
testfolder = getDirectory("select project folder")

// runs shell script for AI segmentation



print("running shell command");
exec("sh","/home/MH_pipline/Run.sh", testfolder);

Print("finsihed shell");
